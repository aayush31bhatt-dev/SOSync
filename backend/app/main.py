...
def auth_db_health() -> dict:
    ...
    try:
        ...
        return {
            ...
            "db_backend_requested": REQUESTED_DB_BACKEND,
            "auth_db_strict_backend": AUTH_DB_STRICT_BACKEND,
            "db_backend_fallback_reason": DB_BACKEND_FALLBACK_REASON,
            "db_path": str(DB_PATH),
